...
public class Team {
    ...
    public Team (@NotNull String name, @NotNull ChatColor color, @NotNull Location spawnPoint, @NotNull Location beaconLocation, @NotNull Location shopLocation, @NotNull Location upgradesLocation) {
        this.name = name;
        this.color = color;
